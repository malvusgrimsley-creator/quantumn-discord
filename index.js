...
client.once('ready', () => {
    ...
    console.log(`📢 Keys will be posted in channel: ${KEY_CHANNEL_ID}`);
...
client.on('messageCreate', async (message) => {
    ...
    if (message.content.startsWith('!genkey')) {
        ...
        if (keyChannel) {
            ...
            await message.reply(`✅ ${config.emoji} Key sent to <#${KEY_CHANNEL_ID}>!`);
        } else {
            ...
            await message.reply('⚠️ Key channel not found, posted here instead.');
        }
    }
});
